...
date: 2022-09-19
tags: [DP,容斥原理,排列组合,min-max容斥,概率论,贡献统计,DP]
...
然后 注意到期望本质是 int p(x) dx, 是可以相加,有分配率的, 因此
...
n个元素, 每次有概率p_i选其中一些元素set_i

S中S_i 表示第i个元素首次被选的发生的次数, (不是期望次数, 而是每个具体的结果中的次数)
...
https://yexiaorain.github.io/Blog/2022-06-05-CF1687/
