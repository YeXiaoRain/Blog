...
date: 2022-10-22
tags: [网络流,rolling hash,字符串hash,Nimber,TODO]
category: [Atcoder,ABC]
description: G(网络流)Ex(rolling hash,Nim积,Nimber)
---
...
$R(A) = \left(\sum_{i=1}^N A_i x^{N-i} \right) \bmod{p}$, ???为啥要次方要倒过来? 字符串对称一下不就是正着的吗
